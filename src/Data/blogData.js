export const blogData = [ 
    ...
    },
    {
        ...
        info1: `We all have phrases and words we use everyday; these are usually common words, representing objects or activity we deasl with regularly and repetiively. Recognizing what these words/object/activties are for your child will help you support their language growth, provide more models, and help them becomed a functional communicator. For many young children, their "core vocabualry" consists of words which have the most meaning to them, that is, things/actions they do/care about. Some examples of such words are: bed, sleep, chair, sit, car, train, doll, ball, play.` ,
    ...
    },
    {
        ...
        info1:"Books can teach your child more than just their contents. Early literaly skills have been shown to improve overall language skills, spelling, reading for comprehesion. These are skills we all need as individuals. Encouragig good literacy skills in children will help them be better learners when they are older, and help them access information more easily. There is more to reading and literacy than just reading the text; children must learn pre-literacy skills, such as page turning, how to turn pages (left-to-right for English speakers), and understandd the concept of a word." ,
        info1Title: "Why books are important" ,
        info1image: "../images/boyreadbook.jpg" , 
        info1imageAlt: "boy reading a book",
        info2: `While young children may not yet be able to read on understand written language, it is never too early to instill pre-literacy skills. Children enjoy looking at images in books, and these can be excellent opportunities to increase vocabulary, follow simple directions ("point to the elephant"), and practice joint attention, while learning your child pre-literacy skills. When they enter kindergarten and first grade, these skills will come in very handy. ` ,
